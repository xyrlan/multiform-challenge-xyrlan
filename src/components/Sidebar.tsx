...
// console.log(currentSteps);
    ...
    return(
        <div 
        className="desktop md:bg-[url('/images/bg-sidebar-desktop.svg')] md:rounded-xl md:w-52 lg:w-52 xl:w-64 h-full max-md:w-full max-md:top-0 max-md:bg-[url('/images/bg-sidebar-mobile.svg')] max-md:absolute max-md:h-[25%]  max-md:flex max-md:justify-center"
        >
